...
from actions.admin.keyboards.admin_success_keyboard import get_kb_reg_success
from data.db_methods import insert_user, delete_admin
from resources.resources import text_end_register_for_admins, get_districts
